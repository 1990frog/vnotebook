...
![形状继承图](_v_images/20190912172409790_1206005909.png)
...
![乐器继承图](_v_images/20190912172423962_289057617.png)
...
![类图](_v_images/20190912172439310_389172894.png)
...
![1562409366637](_v_images/20190912172453436_1822926954.png)

虽然这是一种有用且明智的方法（依赖具体情况），但是也存在缺点。派生类中接口的扩展部分在基类中不存在（不能通过基类访问到这些扩展接口），因此一旦向上转型，就不能通过基类调用这些新方法：

![1562409926765](_v_images/20190912172503888_1578911030.png)
