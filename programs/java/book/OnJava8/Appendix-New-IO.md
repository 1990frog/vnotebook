...
![1554546258113](_v_images/20190912171950973_1980556569.png)
...
![1554546378822](_v_images/20190912172005593_550388283.png)
...
![1554546452861](_v_images/20190912172021601_2070026587.png)
...
![1554546627710](_v_images/20190912172036420_727148082.png)
...
![1554546666685](_v_images/20190912172050057_454168053.png)

两个相对 `get()` 调用将前两个字符的值保存在变量 `c1` 和 `c2` 中。在这两个调用之后，缓冲区看起来是这样的：

![1554546693664](_v_images/20190912172057913_122299625.png)

为了执行交换，我们在位置 0 处编写 `c2`，在位置 1 处编写 `c1`。我们可以使用绝对 `put()` 方法来实现这一点，或者用 `reset()` 方法，将 position 的值设置为 mark：

![1554546847181](_v_images/20190912172109516_1469195093.png)

两个 `put()` 方法分别编写 `c2` 和 `c1` ：

![1554546861836](_v_images/20190912172117739_583764623.png)

在下一次循环中，将 mark 设置为 position 的当前值：

![1554546881189](_v_images/20190912172124444_690891822.png)
...
![1554546890132](_v_images/20190912172135561_586800814.png)
