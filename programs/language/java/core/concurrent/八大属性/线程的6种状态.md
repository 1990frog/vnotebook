...
# 线程的6种状态
![线程的6个状态](_v_images/20191125135006853_659645966.png)

1. New：已创建，但没启动，未执行Run方法
2. Runnable：调用了start方法，未分配资源也是此状态，Runnable可运行的，也可能是已运行中的（yield也是这种状态）
...
# 线程的生命周期
![v2-87f4e9e2e892e56616b55212740818e1_r](_v_images/20191120151130749_1422942536.jpg)
# 阻塞状态
阻塞状态：一般习惯而言，把Blocked（被阻塞）、Waiting（等待）、Timed_waiting（计时等待）都称为阻塞状态，不仅仅是Blocked
# Blocked 对比 waiiting
