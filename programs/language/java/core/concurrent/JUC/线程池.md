...
![](_v_images/20200117214400895_1318557711.png)

# Executor 顶层接口
# ExecutorService 拓展接口
# Executors 工具类，帮忙快速创建线程池

# 线程池实现任务复用的原理
+ 相同线程执行不同任务

![](_v_images/20200117214747815_863613874.png)

![](_v_images/20200117214957086_1499314443.png)
