...
docker exec -it [dockerid] ip a
打印出运行中的容器ip地址

docker stop [dockerid]

docker rm $(docker ps -aq)删除全部退出的容器

docker run -d --name=containerName [dockerimageid]
docker stop containerName

docker --help

docker inspect containerid 显示容器详细信息

docker logs containerid 查看log

查看docker container文档
